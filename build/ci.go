...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/bestyourwallet/op-geth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/bestyourwallet/op-geth/internal/version.gitDate="+env.Date)
	}
	if env.Tag != "" {
		ld = append(ld, "-X", "github.com/bestyourwallet/op-geth/version.gitTag="+env.Tag)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/bestyourwallet/op-geth/core/rawdb", "github.com/bestyourwallet/op-geth/ethdb/leveldb"},
		{"github.com/bestyourwallet/op-geth/core/rawdb", "github.com/bestyourwallet/op-geth/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)
